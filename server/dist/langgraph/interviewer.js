...
import { InterviewStateAnnotation } from "../types/state.js";
...
// 사용자 입력을 처리하는 헬퍼 함수
export async function processUserInput(graph, state, userInput) {
...
// 인터뷰를 시작하는 헬퍼 함수
export async function startInterview(graph, initialState) {
