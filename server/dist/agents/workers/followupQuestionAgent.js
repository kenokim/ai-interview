...
exports.followupQuestionAgent = followupQuestionAgent;
...
async function followupQuestionAgent(state) {
...
당신의 출력은 오직 꼬리질문 텍스트 그 자체여야 합니다. 어떠한 인사말이나 부가 설명도 포함해서는 안 됩니다.`;
    try {
        ...
        return {
            messages: [new messages_1.AIMessage("죄송합니다. 꼬리질문을 생성하는 중 오류가 발생했습니다.")],
            guardrails: {
                is_safe: false,
